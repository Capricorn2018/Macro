function  M = cal_S0027908(start_date)


  %  {'产量:汽车:当月同比','重点行业','月','S0027908','','统计局'}

    load(['D:\Projects\Macro\data\raw\','S0027908','.mat'],'M');
...
spec = makespec( 'TRAMO', 'AUTO', 'X11', 'SPECTRUM',...
     'regression', 'variables','(const td  AO2005.Jan AO2008.Jan LS2010.Feb AO2013.Jan  AO2020.Mar)',...
